  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-normal tracking-wide transition-all duration-500 ease-out focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "bg-primary text-primary-foreground hover:bg-primary/80 active:bg-primary/70 px-8 py-3.5 text-xs tracking-[0.15em] uppercase font-sans rounded-sm hover:shadow-lg hover:shadow-primary/25 active:translate-y-0.5",
        calm: "border border-primary/30 text-foreground hover:border-primary hover:text-primary hover:bg-primary/5 bg-transparent px-8 py-3.5 text-xs tracking-[0.15em] uppercase font-sans rounded-sm",
      },
      size: {

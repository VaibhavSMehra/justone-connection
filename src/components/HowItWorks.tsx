...
const steps = [
  {
    ...
    description: "A short, thoughtful questionnaire about you, your values, and the kind of connection you want right now. No photos. No bios. No posturing.",
  },
  {
    number: "02",
    ...
    <section ref={ref} className="section-spacing px-6 relative">
      ...
      <div className="section-container relative">
        ...
        <motion.p 
          ...
          className="text-center text-muted-foreground/70 text-base font-light mt-16 max-w-md mx-auto italic"
        >
          Some connections don't need options.
          <br />
          They need intention.
        </motion.p>
      </div>

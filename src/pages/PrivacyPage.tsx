...
const PrivacyPage = () => {
  ...
  useEffect(() => {
    document.title = "Privacy Policy | JustOne";
      ...
      <section className="pt-28 pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <header className="mb-10">
            <h1 className="font-display font-light text-4xl md:text-5xl text-foreground tracking-wide">
              Privacy Policy
            </h1>
            <div className="divider-thin mt-6" />
            <p className="text-xs text-muted-foreground mt-6">Last updated: {today}</p>
          </header>
          ...
          <article className="prose prose-sm max-w-none text-foreground/90">
            ...
            <section className="mb-8">
              ...
              <p className="text-sm text-primary font-medium mt-2">support@justonematch.in</p>
            </section>
